    ...
    def _sample(
        ...
        **kwargs,
        ...
        #    breakpoint()
            ...
            prefill = self.forward_dream(None, attention_mask, tok_idx,inputs_embeds=inputs_embeds.to(dtype),use_cache=True)
        ...
        for i in range(steps):
            ...
            if not prefix_lm:
                ...
                logits = self.forward_dream(None, attention_mask, tok_idx,inputs_embeds=inputs_embeds_curr,past_key_values=past_key_values).logits
                logits = torch.cat([logits[:,:1], logits[:, :-1]], dim=1)
