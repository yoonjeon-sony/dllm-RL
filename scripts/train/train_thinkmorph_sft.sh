...
DATA_PATH=${DATA_PATH:-"./scripts/data/thinkmorph_und.yaml"}
IMG_PATH=${IMG_PATH:-"/group2/dgm/yoonjeon/data"}
RUN_NAME=${RUN_NAME:-"sft-lavidao-thinkmorph"}
export WANDB_DIR=/home/yoonjeon.kim/dLLM-RL/wandb
...
torchrun \
    ...
    --output_dir "/group2/dgm/yoonjeon/ckpts/${MID_RUN_NAME}" \
    --num_train_epochs 10 \
